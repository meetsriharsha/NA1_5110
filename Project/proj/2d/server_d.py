    ...
    while True:
        ...
        for sock in read_sockets:
            ...
            if sock == server_socket:
                ...
                broadcast_MessageTo_Clients(sockfd, "Server Message...%r entered chat\n" % str(addr))
            ...
            # Data received from old connected client
                ...
                try:
                    ...
                    if data:
                        ...
                        broadcast_MessageTo_Clients(sock, "\r" + '<' + str(sock.getpeername()) + '> ' + data)                
                    elif not data:
                       print "%r :: Client %s is offline" % (time.ctime(), str(sock.getpeername()))
                       broadcast_MessageTo_Clients(sock, "Client %r is offline.\n" % str(sock.getpeername()))
                       sock.close()
